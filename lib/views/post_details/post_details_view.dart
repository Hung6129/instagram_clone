...
import 'package:instagram_clone/views/components/comment/compact_comments_column.dart';
            ...
            IconButton(
              ...
              onPressed: () async {
                final shouldDeletePost =
                    await const DeleteDialog(titleOfObjectToDelete: Strings.post).present(context).then((shouldDelete) => shouldDelete ?? false);
                if (shouldDeletePost) {
